...
?>
		<div class="content">
			<form action="sign_up.php" method="post">
				<h3 class="center mb-5"><i class="fa fa-user-plus"> Sign Up</i> </h3>
				...
				<div class="container-fluid center">
					<div class="row form-group">
						...
						<div class="col-5">
						<input class="form-control" type="text" name="username" value="<?php if(isset($_POST['username'])){echo htmlentities($_POST['username'], ENT_QUOTES, 'UTF-8');} ?>" />
						</div>
					</div>

					<div class="row form-group">
						<div class="col-4">
						<label for="password">Password<span class="small">(8 characters min.)</span></label>
						</div>
						<div class="col-5">
					...
					<div class="row form-group">
						<div class="col-4">
						<label for="passverif">Confirm Password</label>
						</div>

						<div class="col-5">
						<input class="form-control" type="password" name="passverif" />
						</div>
					</div>
					...
					<div class="row form-group">
						...
						<div class="col-5">
						<input class="form-control" type="text" name="email" value="<?php if(isset($_POST['email'])){echo htmlentities($_POST['email'], ENT_QUOTES, 'UTF-8');} ?>" />
						</div>
					</div>
					...
					<div class="row form-group">
						...
						<div class="col-5">
						<input class="form-control" type="text" name="avatar" value="<?php if(isset($_POST['avatar'])){echo htmlentities($_POST['avatar'], ENT_QUOTES, 'UTF-8');} ?>" />
						</div>
					</div>
