...
?>
		<div class="content">
			<form action="edit_infos.php" method="post">
				 <h3 class="center mb-5"> <i class="fa fa-edit"> Update personal information </i></h3>
				<div class="container-fluid center">
					...
					<div class="row form-group">
						<div class="col-4">
						<label for="password">New Password<span class="small">(8 characters min.)</span></label>
						</div>
						<div class="col-5">
					...
					<div class="row form-group">
						...
						<div class="col-5">
						<input class="form-control" type="password" name="passverif" id="passverif" value="" />
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-4">
						<label for="confirm">Old Password<span class="small"></span></label>
						</div>
