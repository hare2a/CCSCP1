...
<a class="btn btn-danger my-3" href="connexion.php"><i class="fa fa-sign-out-alt"></i> Logout</a>
<?php
}
else {
...
<div class="row pl-5" >
	...
	<div class="col-3">
		<a class="btn btn-warning"  href="connexion.php"> <i class="fa fa-sign-in-alt"></i> Log in</a>
	</div>
</div>
<?php
}
